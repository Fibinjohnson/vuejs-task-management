...
6
 ...
 <div  v-else class="flex justify-between ml-auto space-x-10 mr-auto px-3 py-1">
  <div  class="flex flex-col h-18">
    <div v-if="completedTodosCount===0" class=" flex justify-center  align-center p-48 pr-96" ><p> No Completed Todos</p></div>
  ...
  <div  class="flex flex-col ">
    <div class="justify-center align-center p-48 pr-96"   v-if="activeTodosCount===0">No active Todos</div>
